export default [
    {
        "title": "Figure 03 : L'avènement des robots humanoïdes domestiques grâce à Helix",
        "description": "Lancé officiellement fin 2025 et déployé début 2026, le Figure 03 marque une rupture : c'est le premier robot de la marque conçu pour la production de masse et l'usage domestique, propulsé par le système d'intelligence physique Helix.",
        "date": "12 février 2026",
        "content": [
            "<h3>Introduction</h3><p>Après le succès industriel du Figure 02 chez BMW, Figure AI a franchi une étape historique en février 2026 avec l'accélération de la production du Figure 03. Contrairement aux versions précédentes, ce modèle n'est plus un prototype de recherche mais un produit fini, capable d'évoluer dans des environnements non structurés comme nos maisons. Sa particularité ? Une intelligence physique 'maison' nommée Helix, qui remplace les collaborations précédentes pour un contrôle total de la causalité action-réaction.</p>",
            "<h3>Le système Helix : L'intelligence embarquée</h3><p>Le Figure 03 est animé par Helix, un modèle d'IA multimodal qui traite directement les flux vidéo en actions motrices (pixels-to-action). Cette architecture permet au robot de comprendre les lois de la physique en temps réel. Grâce à une connectivité mmWave de 10 Gbps, le robot apprend continuellement de la flotte mondiale, améliorant sa dextérité pour des tâches complexes comme la manipulation d'objets fragiles ou la gestion d'imprévus domestiques.</p>",
            "<h3>Conception orientée pour l'humain</h3><p>Sur le plan physique, le Figure 03 est 9 % plus léger que son prédécesseur et arbore pour la première fois un revêtement textile doux (soft goods) plutôt qu'une coque métallique rigide. Ce design réduit les risques de pincement et rend les interactions plus sûres dans un foyer. Ses mains ont été affinées avec des capteurs tactiles capables de ressentir le poids d'un simple trombone, permettant une précision inédite dans la préparation des repas ou le rangement.</p>",
            "<h3>Autonomie et Production de Masse</h3><p>Figure AI a inauguré BotQ, une usine de haute technologie capable de produire jusqu'à 12 000 unités par an dès début 2026. Le Figure 03 dispose d'une autonomie de 5 heures et utilise une station de recharge sans fil au sol. Ce passage à l'échelle industrielle a permis de réduire les coûts de fabrication de 90 % par rapport aux premiers prototypes, rapprochant le prix de vente d'une voiture familiale.</p>",
            "<h3>Conclusion</h3><p>Le Figure 03 ne se contente pas de simuler des mouvements ; il raisonne sur son environnement pour devenir une aide domestique polyvalente. En s'affranchissant des modèles de langage généralistes pour se concentrer sur l'intelligence physique, Figure AI définit le nouveau standard de la robotique humanoïde du quotidien.</p>"
        ],
        "images": [
            {
                "url": "https://gcp-na-images.contentstack.com/v3/assets/bltea6093859af6183b/bltda3c539c9db18b86/6998ca88e1ba00521698dfcc/figure-03-time-best-inventions-2025-03.jpg?branch=production&quot",
                "caption": "La Figure 03 rangeant la vaisselle."
            }
        ],
        "sources": [
            {
                "title": "Figure AI - Introducing Figure 03",
                "url": "https://www.figure.ai/news/introducing-figure-03"
            },
            {
                "title": "TIME - Figure 03 Is The Robot in Your Kitchen",
                "url": "https://time.com/7324233/figure-03-robot-humanoid-reveal/"
            },
            {
                "title": "Robozaps - Figure 03 Review: Home Robot 2026",
                "url": "https://blog.robozaps.com/b/figure-03-review"
            }
        ]
    },

    {
        "title": "NVIDIA Isaac GR00T : Le cerveau universel qui révolutionne la robotique humanoïde",
        "description": "Dévoilé lors de la GTC et perfectionné début 2026, le projet GR00T (Generalist Robot 00 Technology) est un modèle de fondation multimodal permettant aux robots d'apprendre par imitation et de comprendre le langage naturel.",
        "date": "18 mars 2026",
        "content": [
            "<h3>Introduction</h3><p>Le Projet GR00T représente la pierre angulaire de la stratégie 'Physical AI' de NVIDIA. Ce modèle de base universel permet aux robots humanoïdes de percevoir le monde, de comprendre des instructions verbales et d'imiter les mouvements humains. L'objectif de Jensen Huang est clair : créer un standard logiciel capable de piloter n'importe quel robot, indépendamment de son constructeur, à l'image d'Android pour les smartphones.</p>",
            "<h3>Architecture Cognitive : Système 1 et Système 2</h3><p>Depuis la mise à jour Isaac GR00T N1, le modèle repose sur une architecture à double système inspirée de la cognition humaine. Le 'Système 1' gère les réflexes et la motricité rapide (équilibre, évitement immédiat), tandis que le 'Système 2' s'occupe du raisonnement analytique et de la planification à long terme. Cette dualité permet au robot de rester stable tout en réfléchissant à la meilleure manière d'exécuter une commande complexe.</p>",
            "<h3>Jetson Thor : Le processeur dédié</h3><p>Pour faire tourner GR00T localement, NVIDIA a conçu Jetson Thor, un nouveau SoC (System-on-Chip) offrant 800 téraflops de puissance de calcul IA. Ce processeur est optimisé pour les modèles de transformateurs multimodaux, permettant au robot de traiter les données de ses capteurs (LiDAR, caméras, microphones) en temps réel sans dépendre d'une connexion cloud, garantissant ainsi sécurité et réactivité.</p>",
            "<h3>Entraînement via Isaac Lab et Omniverse</h3><p>Le succès de GR00T repose sur sa capacité à s'entraîner dans des mondes virtuels. Grâce à NVIDIA Omniverse et Isaac Lab, les robots peuvent simuler des milliers d'heures d'expérience en quelques minutes dans des environnements physiquement exacts. Ce passage du 'virtuel au réel' (Sim-to-Real) réduit drastiquement le temps d'apprentissage pour des tâches délicates comme le pliage de linge ou la manipulation d'outils industriels.</p>",
            "<h3>Conclusion</h3><p>En ouvrant son écosystème à des leaders comme Agility Robotics, Boston Dynamics et Figure AI, NVIDIA ne se contente plus de vendre des puces : elle impose son système d'exploitation comme le standard mondial. GR00T marque le passage des robots programmés pour une tâche unique aux robots généralistes capables d'apprendre et d'évoluer à nos côtés.</p>"
        ],
        "images": [
            {
                ...
                "caption": "Jensen Huang présentant les robots humanoïdes entraînés sous le projet GR00T."
            }
        ],
        "sources": [
            {
    ...
    },
    {
        ...
        "images": [
            {
                "url": "https://pic.clubic.com/v1/images/2172910/raw?fit=smartCrop&width=1200&height=913&hash=9dcd0a218a4eb97f4e285eb7608c01f37420b68e",
                "caption": "Optimus Gen 2 manipulant un oeuf."
            }
        ],
        "sources": [
            {
                "title": "Clubic",
                "url": "https://www.clubic.com/actualite-512407-optimus-gen-2-tesla-devoile-la-nouvelle-generation-de-son-robot-humanoide-c-est-bluffant.html"
            },
            {
                "title": "Le Big Data",
                "url": "https://www.lebigdata.fr/tesla-optimus-gen-2"
            },
            {
                "title": "Motor1 France",
